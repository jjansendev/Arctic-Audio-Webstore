    ...
    <div className="min-h-screen">
      ...
      <section className="px-6 pt-8 md:px-12">
        <div className="mx-auto w-full max-w-6xl">
          <Link
            href="/products"
            className="inline-flex items-center gap-2 text-sm text-white/60 transition hover:text-arctic-cyan"
          >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {product.features.map((feature, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 rounded-panel border border-white/5 bg-white/5 p-4 transition hover:border-arctic-cyan/20 hover:bg-white/10"
                  >
                  ...
                  {product.bundleProducts.map((slug) => {
                    ...
                    return bundledProduct ? (
                      <li key={slug} className="flex items-center gap-3 text-sm text-white/80">
                        ...
                        <Link
                          href={`/products/${slug}`}
                          className="hover:text-arctic-cyan transition"
                        >
                          {bundledProduct.name}
                        </Link>
                      </li>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                <Link
                  href="/support"
                  className="block rounded-panel border border-white/10 bg-white/5 p-3 text-sm text-white/80 transition hover:border-arctic-cyan/30 hover:bg-white/10"
                >
                  Contact Support
                </Link>
                <Link
